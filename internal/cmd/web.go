...
import (
	...
	"github.com/3tel/icp-web/internal/conf"
	"github.com/3tel/icp-web/static"
	"github.com/3tel/icp-web/templates"
)

var Web = &cli.Command{
	Name:  "web",
	Usage: "Start web server",
	Description: `icpweb server is the only thing you need to run,
...
func runWeb(c *cli.Context) error {
	...
	f.Get("/", func(ctx flamego.Context, t template.Template, data template.Data) {
		...
		// data["title"] = host
		data["title"] = conf.GetTITLEByURL(host)
